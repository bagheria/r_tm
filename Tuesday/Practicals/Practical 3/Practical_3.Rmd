...
|     **Use these sentences as our training set and create a document-term matrix (dtm). Hint: Use the tm package. To create a dtm first you need to create a vector space model.**
...
3. **Convert the dtm object to a matrix and add a 'y' column as the outcome variable which has the values of 0 for the first row and 1 for the second row. Then convert the dtm to a dataframe**
